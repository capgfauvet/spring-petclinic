...
INSERT INTO owners (first_name, last_name, address, city, telephone) SELECT 'George', 'Franklin', '44 Duplicate Ave.', 'Madison', '6085551023' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=11);
